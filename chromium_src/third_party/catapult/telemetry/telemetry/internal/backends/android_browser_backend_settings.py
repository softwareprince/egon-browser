...
ANDROID_BRAVE = GenericChromeBackendSettings(browser_type='android-brave',
                                             package='com.egonbrowser.browser')

ANDROID_BRAVE_BETA = GenericChromeBackendSettings(
    browser_type='android-brave-beta', package='com.egonbrowser.browser_beta')

ANDROID_BRAVE_DEV = GenericChromeBackendSettings(
    browser_type='android-brave-dev', package='com.egonbrowser.browser_dev')

ANDROID_BRAVE_NIGHTLY = GenericChromeBackendSettings(
    browser_type='android-brave-nightly', package='com.egonbrowser.browser_nightly')
