...
let locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' EgonBrowser Software. EgonBrowser is a registered trademark of EgonBrowser Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this EgonBrowser Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from EgonBrowser in the event of data loss on your device.',
  ads: 'Ads',
  ad: 'Ad',
  ...
  braveAdsTitle: 'EgonBrowser Ads',
  braveAdsLaunchTitle: 'EgonBrowser Ads has arrived!',
  ...
  braveRewards: 'EgonBrowser Rewards',
  ...
  braveRewardsTitle: 'EgonBrowser Rewards',
  ...
  disabledPanelPrivateText: 'EgonBrowser Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'EgonBrowser Rewards is',
  dismiss: 'Closed',
  ...
  enableRewards: 'Enable EgonBrowser Rewards',
  ...
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the EgonBrowser User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no EgonBrowser Ads history',
  ...
  relaunch: 'Relaunch',
  remove: 'remove',
  resetWallet: 'Reset EgonBrowser Rewards',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined EgonBrowser’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsWidgetEgonBrowserRewards: 'EgonBrowser Rewards',
  saveAd: 'Save',
  saved: 'Saved',
  ...
  serviceText: 'By clicking \'Enable EgonBrowser Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on EgonBrowser Rewards, you indicate that you have read and agree to the',
  ...
  turnOnRewardsDesc: 'This enables both EgonBrowser Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from EgonBrowser users.',
  ...
  walletDisconnect: 'Log out from EgonBrowser Rewards',
  ...
  walletVerificationList3: 'Withdraw BAT that you may have previously added to your EgonBrowser Rewards wallet',
  ...
  walletVerificationNote2: 'EgonBrowser Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused EgonBrowser Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'EgonBrowser Payments is now EgonBrowser Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very EgonBrowser way to browse the web.',
  whyEgonBrowserRewards: 'Why EgonBrowser Rewards?',
  whyEgonBrowserRewardsDesc1: 'With conventional browsers, you pay to browse the web by viewing ads with your valuable attention, spending your valuable time downloading invasive ad technology, that transmits your valuable private data to advertisers — without your consent.',
  whyEgonBrowserRewardsDesc2: 'Well, you\'ve come to the right place. EgonBrowser welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showEgonBrowserStats: 'Show EgonBrowser Stats',
  braveTalkWidgetTitle: 'EgonBrowser Talk',
