...
public final class BraveConstants {
    ...
    public static final String BRAVE_PRODUCTION_PACKAGE_NAME = "com.egonbrowser.browser";
    public static final String BRAVE_BETA_PACKAGE_NAME = "com.egonbrowser.browser_beta";
    public static final String BRAVE_NIGHTLY_PACKAGE_NAME = "com.egonbrowser.browser_nightly";

    // used in BraveNtpAdapter
    public static final String BRAVE_REF_URL = "https://egonbrowser.com/";
