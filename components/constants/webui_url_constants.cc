...
const char kBraveUIWalletOnboardingURL[] = "egon://wallet/crypto/onboarding";
const char kBraveUIWalletAccountCreationURL[] =
    "egon://wallet/crypto/accounts/add-account/create/";
...
const char kExtensionSettingsURL[] = "egon://settings/extensions";
const char kWalletSettingsURL[] = "egon://settings/wallet";
...
const char kFederatedInternalsURL[] = "egon://federated-internals";
