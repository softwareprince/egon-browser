...
TEST(BraveAdsUrlUtilTest, DoesNotSupportBraveSchemeWithFooBarHostName) {
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://foobar")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithWalletHostName) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://wallet")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithWalletHostNameAndPath) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://wallet/foo")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithSyncHostName) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://sync")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithSyncHostNameAndPath) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://sync/foo")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithRewardsHostName) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://rewards")));
}
...
TEST(BraveAdsUrlUtilTest, DoesSupportBraveSchemeWithRewardsHostNameAndPath) {
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://rewards/foo")));
}
...
TEST(BraveAdsUrlUtilTest, DoesNotSupportBraveSchemeWithSettingsHostName) {
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings/foobar")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://settings/searchEngines")));
}
...
TEST(
  ...
  // Assert
  EXPECT_TRUE(
      DoesSupportUrl(GURL("egon://settings/searchEngines?search=foobar")));
}
...
TEST(
  ...
  EXPECT_FALSE(DoesSupportUrl(
      GURL("egon://settings/searchEngines?search=foo&bar=baz")));
}
...
TEST(
  ...
  // Act
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings/searchEngines?search")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://settings/search")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_TRUE(DoesSupportUrl(GURL("egon://settings/search?search=foobar")));
}
...
TEST(
  ...
  // Assert
  EXPECT_FALSE(
      DoesSupportUrl(GURL("egon://settings/search?search=foo&bar=baz")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings/search?search")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings/?search=foobar")));
}
...
TEST(BraveAdsUrlUtilTest,
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("egon://settings/?search")));
}
...
TEST(BraveAdsUrlUtilTest, MalformedUrlIsNotSupported) {
  ...
  // Assert
  EXPECT_FALSE(DoesSupportUrl(GURL("http://foobar.com/egon://wallet")));
}
