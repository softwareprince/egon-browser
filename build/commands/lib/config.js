...
const Config = function () {
  this.sardineClientId = getNPMConfig(['sardine_client_id']) || 'mjhgfkthrjy'
  this.sardineClientSecret = getNPMConfig(['sardine_client_secret']) || 'mjhgfkthrjy'
  ...
  this.googleDefaultClientId = getNPMConfig(['google_default_client_id']) || 'mjhgfkthrjy'
  this.googleDefaultClientSecret = getNPMConfig(['google_default_client_secret']) || 'mjhgfkthrjy'
  this.braveServicesKey = getNPMConfig(['brave_services_key']) || 'mjhgfkthrjy'
  this.infuraProjectId = getNPMConfig(['brave_infura_project_id']) || 'mjhgfkthrjy'
  this.braveZeroExApiKey = getNPMConfig(['brave_zero_ex_api_key']) || 'mjhgfkthrjy'
  this.bitFlyerProductionClientId = getNPMConfig(['bitflyer_production_client_id']) || 'mjhgfkthrjy'
  this.bitFlyerProductionClientSecret = getNPMConfig(['bitflyer_production_client_secret']) || 'mjhgfkthrjy'
  this.bitFlyerProductionFeeAddress = getNPMConfig(['bitflyer_production_fee_address']) || 'mjhgfkthrjy'
  this.bitFlyerProductionUrl = getNPMConfig(['bitflyer_production_url']) || 'mjhgfkthrjy'
  this.bitFlyerSandboxClientId = getNPMConfig(['bitflyer_sandbox_client_id']) || 'mjhgfkthrjy'
  this.bitFlyerSandboxClientSecret = getNPMConfig(['bitflyer_sandbox_client_secret']) || 'mjhgfkthrjy'
  this.bitFlyerSandboxFeeAddress = getNPMConfig(['bitflyer_sandbox_fee_address']) || 'mjhgfkthrjy'
  this.bitFlyerSandboxUrl = getNPMConfig(['bitflyer_sandbox_url']) || 'mjhgfkthrjy'
  this.geminiProductionApiUrl = getNPMConfig(['gemini_production_api_url']) || 'mjhgfkthrjy'
  this.geminiProductionClientId = getNPMConfig(['gemini_production_client_id']) || 'mjhgfkthrjy'
  this.geminiProductionClientSecret = getNPMConfig(['gemini_production_client_secret']) || 'mjhgfkthrjy'
  this.geminiProductionFeeAddress = getNPMConfig(['gemini_production_fee_address']) || 'mjhgfkthrjy'
  this.geminiProductionOauthUrl = getNPMConfig(['gemini_production_oauth_url']) || 'mjhgfkthrjy'
  this.geminiSandboxApiUrl = getNPMConfig(['gemini_sandbox_api_url']) || 'mjhgfkthrjy'
  this.geminiSandboxClientId = getNPMConfig(['gemini_sandbox_client_id']) || 'mjhgfkthrjy'
  this.geminiSandboxClientSecret = getNPMConfig(['gemini_sandbox_client_secret']) || 'mjhgfkthrjy'
  this.geminiSandboxFeeAddress = getNPMConfig(['gemini_sandbox_fee_address']) || 'mjhgfkthrjy'
  this.geminiSandboxOauthUrl = getNPMConfig(['gemini_sandbox_oauth_url']) || 'mjhgfkthrjy'
  this.upholdProductionApiUrl = getNPMConfig(['uphold_production_api_url']) || 'mjhgfkthrjy'
  this.upholdProductionClientId = getNPMConfig(['uphold_production_client_id']) || 'mjhgfkthrjy'
  this.upholdProductionClientSecret = getNPMConfig(['uphold_production_client_secret']) || 'mjhgfkthrjy'
  this.upholdProductionFeeAddress = getNPMConfig(['uphold_production_fee_address']) || 'mjhgfkthrjy'
  this.upholdProductionOauthUrl = getNPMConfig(['uphold_production_oauth_url']) || 'mjhgfkthrjy'
  this.upholdSandboxApiUrl = getNPMConfig(['uphold_sandbox_api_url']) || 'mjhgfkthrjy'
  this.upholdSandboxClientId = getNPMConfig(['uphold_sandbox_client_id']) || 'mjhgfkthrjy'
  this.upholdSandboxClientSecret = getNPMConfig(['uphold_sandbox_client_secret']) || 'mjhgfkthrjy'
  this.upholdSandboxFeeAddress = getNPMConfig(['uphold_sandbox_fee_address']) || 'mjhgfkthrjy'
  this.upholdSandboxOauthUrl = getNPMConfig(['uphold_sandbox_oauth_url']) || 'mjhgfkthrjy'
  this.zebPayProductionApiUrl = getNPMConfig(['zebpay_production_api_url']) || 'mjhgfkthrjy'
  this.zebPayProductionClientId = getNPMConfig(['zebpay_production_client_id']) || 'mjhgfkthrjy'
  this.zebPayProductionClientSecret = getNPMConfig(['zebpay_production_client_secret']) || 'mjhgfkthrjy'
  this.zebPayProductionOauthUrl = getNPMConfig(['zebpay_production_oauth_url']) || 'mjhgfkthrjy'
  this.zebPaySandboxApiUrl = getNPMConfig(['zebpay_sandbox_api_url']) || 'mjhgfkthrjy'
  this.zebPaySandboxClientId = getNPMConfig(['zebpay_sandbox_client_id']) || 'mjhgfkthrjy'
  this.zebPaySandboxClientSecret = getNPMConfig(['zebpay_sandbox_client_secret']) || 'mjhgfkthrjy'
  this.zebPaySandboxOauthUrl = getNPMConfig(['zebpay_sandbox_oauth_url']) || 'mjhgfkthrjy'
  this.braveSyncEndpoint = getNPMConfig(['brave_sync_endpoint']) || 'mjhgfkthrjy'
  this.safeBrowsingApiEndpoint = getNPMConfig(['safebrowsing_api_endpoint']) || 'mjhgfkthrjy'
  this.updaterProdEndpoint = getNPMConfig(['updater_prod_endpoint']) || 'mjhgfkthrjy'
  this.updaterDevEndpoint = getNPMConfig(['updater_dev_endpoint']) || 'mjhgfkthrjy'
  this.webcompatReportApiEndpoint = getNPMConfig(['webcompat_report_api_endpoint']) || 'https://webcompat.brave.com/1/webcompat'
  this.rewardsGrantDevEndpoint = getNPMConfig(['rewards_grant_dev_endpoint']) || 'mjhgfkthrjy'
  this.rewardsGrantStagingEndpoint = getNPMConfig(['rewards_grant_staging_endpoint']) || 'mjhgfkthrjy'
  this.rewardsGrantProdEndpoint = getNPMConfig(['rewards_grant_prod_endpoint']) || 'mjhgfkthrjy'
  ...
  this.mac_installer_signing_identifier = getNPMConfig(['mac_installer_signing_identifier']) || 'mjhgfkthrjy'
  this.mac_signing_keychain = getNPMConfig(['mac_signing_keychain']) || 'login'
  this.sparkleDSAPrivateKeyFile = getNPMConfig(['sparkle_dsa_private_key_file']) || 'mjhgfkthrjy'
  this.sparkleEdDSAPrivateKey = getNPMConfig(['sparkle_eddsa_private_key']) || 'mjhgfkthrjy'
  this.sparkleEdDSAPublicKey = getNPMConfig(['sparkle_eddsa_public_key']) || 'mjhgfkthrjy'
  this.notary_user = getNPMConfig(['notary_user']) || 'mjhgfkthrjy'
  this.notary_password = getNPMConfig(['notary_password']) || 'mjhgfkthrjy'
  ...
  this.braveStatsApiKey = getNPMConfig(['brave_stats_api_key']) || 'mjhgfkthrjy'
  this.braveStatsUpdaterUrl = getNPMConfig(['brave_stats_updater_url']) || 'mjhgfkthrjy'
  this.p3aJsonUploadUrl = getNPMConfig(['p3a_json_upload_url']) || 'mjhgfkthrjy'
  this.p3aCreativeUploadUrl = getNPMConfig(['p3a_creative_upload_url']) || 'mjhgfkthrjy'
  this.p2aJsonUploadUrl = getNPMConfig(['p2a_json_upload_url']) || 'mjhgfkthrjy'
  this.p3aConstellationUploadUrl = getNPMConfig(['p3a_constellation_upload_url']) || 'mjhgfkthrjy'
  this.starRandomnessHost = getNPMConfig(['star_randomness_host']) || 'mjhgfkthrjy'
  this.ignore_compile_failure = false
  this.enable_hangout_services_extension = true
  this.enable_pseudolocales = false
  this.sign_widevine_cert = process.env.SIGN_WIDEVINE_CERT || 'mjhgfkthrjy'
  this.sign_widevine_key = process.env.SIGN_WIDEVINE_KEY || 'mjhgfkthrjy'
  this.sign_widevine_passwd = process.env.SIGN_WIDEVINE_PASSPHRASE || 'mjhgfkthrjy'
  this.signature_generator = path.join(this.srcDir, 'third_party', 'widevine', 'scripts', 'signature_generator.py') || 'mjhgfkthrjy'
  this.extraGnArgs = {}
  this.extraGnGenOpts = getNPMConfig(['brave_extra_gn_gen_opts']) || ''
  this.extraNinjaOpts = []
  this.braveAndroidSafeBrowsingApiKey = getNPMConfig(['brave_safebrowsing_api_key']) || 'mjhgfkthrjy'
  this.braveSafetyNetApiKey = getNPMConfig(['brave_safetynet_api_key']) || 'mjhgfkthrjy'
  this.braveAndroidDeveloperOptionsCode = getNPMConfig(['brave_android_developer_options_code']) || 'mjhgfkthrjy'
  ...
  this.braveVariationsServerUrl = getNPMConfig(['brave_variations_server_url']) || 'mjhgfkthrjy'
  ...
  this.brave_ai_chat_endpoint = getNPMConfig(['brave_ai_chat_endpoint']) || 'mjhgfkthrjy'
...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    if (!this.isReleaseBuild()) {
      ...
      args.chrome_public_manifest_package = 'com.egonbrowser.browser'
    } else if (this.channel === 'beta') {
      args.chrome_public_manifest_package = 'com.egonbrowser.browser_beta'
    } else if (this.channel === 'dev') {
      args.chrome_public_manifest_package = 'com.egonbrowser.browser_dev'
    } else if (this.channel === 'nightly') {
      args.android_channel = 'canary'
      args.chrome_public_manifest_package = 'com.egonbrowser.browser_nightly'
    }
